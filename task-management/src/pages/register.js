...
export default function Register() {
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 grid grid-cols-auto-fill-50 grid-rows-auto-fill-50 pointer-events-none -z-10">
        {grid.map((item) => (
          <div 
            key={item.id}
            className={`border ${
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className={`mb-8 ${
            ...
            Create your account to start organizing tasks like never before
          </p>
